...
const MessageModal = ({ isOpen, onClose, type, title, message, transparentBackdrop = false, lightBackdrop = false }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[150] flex items-center justify-center animate-fade-in ${transparentBackdrop ? 'bg-transparent' : lightBackdrop ? 'bg-black/20' : 'bg-black/40'} backdrop-blur-none`}
      style={transparentBackdrop ? { backdropFilter: 'none', WebkitBackdropFilter: 'none' } : undefined}
    >
