...
function TrackApplication() {
  ...
  <div className='flex flex-col w-full max-w-2xl items-center rounded-[8px] gap-8 p-6 md:p-10 bg-white shadow-sm track-container'>
    ...
    <div className='flex flex-col md:flex-row items-center gap-4 w-full'>
      ...
      <button className='w-full md:w-auto flex justify-center items-center gap-2 bg-[#2C2D86] text-white font-semibold rounded hover:bg-opacity-90 transition-all check-status-btn'>
        <CiSearch size={25}/>
