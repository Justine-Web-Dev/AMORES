...
function DashboardOverview() {
  ...
  const processMetrics = (allData, yearFilter) => {
    ...
    // 1. Status Breakdown (Separated Document Review)
    const statuses = {
      "New Applicant": 0,
      "Document Review": 0,
      Screening: 0,
    ...
    // Removed "Document Review" so it tracks independently
    ...
    data.forEach((a) => {
      ...
      else if (a.status === "Document Review") statuses["Document Review"]++;
  ...
  // Chart colors expanded to look good with more slices
  const CHART_COLORS = [
    "#2C2D86",
    "#EB612A",
    "#10B981",
        ...
        <div className="stat-card-container top-summary-cards">
          ...
          <div className="admin-summary-card new-applicants">
            <div className="flex flex-col-reverse items-center">
              ...
              <span className="summary-value">
                {statusCounts["Document Review"] || 0}
              </span>
            </div>
          </div>
