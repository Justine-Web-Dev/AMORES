  ...
  const handleRunScreening = async () => {
    ...
    try {
      ...
      setModalConfig({
        ...
        type: "success",
        message:
          "Initial screening completed! The applicant status has been updated based on the automated rules.",
      });
      ...
      setModalConfig({
        ...
        message:
          ...
          "Failed to run initial screening. Please try again.",
      });
    ...
    <div className="flex flex-col justify-evenly bg-[#F9FAFB] shadow-sm mt-5 rounded-[12px] p-6 border border-yellow-200">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Please verify the following manual checks. The system will
          automatically evaluate Age, Height, and Education.
        </p>
      </div>
